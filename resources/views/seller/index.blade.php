                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Acc Number</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group me-2">
                                            <a href="{{ route('seller.edit', $data) }}" class="btn btn-secondary btn btn-outline-primar btn-sm">Edit</a>
                                            <a href="/hapusseller/{{$data->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this data?')">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
