...
@endsection
@section('page', 'Product Categories ZZF / Edit')
@section('main')
          ...
          <div class="card mb-4">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('prodcatzzf.update', $category)}}" method="POST" id="frmUser">
                @method('PUT')
                @csrf
                ...
                <div class="col-3">
                    <a href="{{ route('prodcatzzf.index') }}" class="btn bg-gradient-secondary w-100">Cancel</a>
                </div>
                <div class="col-3">
