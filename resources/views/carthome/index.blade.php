                    ...
                    <tbody>
                        @foreach ($cartItems as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('carthome.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
...
<br><br>
    ...
    function updateTotal(input) {
        ...
        // Update total di sel
        totalCell.innerHTML = 'Rp' + total.toLocaleString('id-ID', { minimumFractionDigits: 0 });
        totalCell.dataset.total = total; // Update data total
    }
        ...
        function updateTotal(input) {
            ...
            document.querySelectorAll('.total-price').forEach(function(item) {
                grandTotal += parseFloat(item.dataset.total); // Ambil data total dari setiap item
            });
