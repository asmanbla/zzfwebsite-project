          ...
          <div class="card mb-4">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('userzzf.update', $user)}}" method="POST" id="frmUser">
                @method('PUT')
                @csrf
                    <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder="masukkan email anda" aria-label="email" required value="{{$user->email ?? old('email')}}">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="password"class="form-label">Password</label>
                        <input type="password" id="password" name="password" class="form-control" placeholder="masukkan password anda" aria-label="password" required value="{{$user->password ?? old('password')}}">
                     </div>
                     <div class="mb-3 ms-3 me-3"> 
