      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <a href="{{ route('bestproduct.create')}}"><span class="badge badge-sm bg-gradient-primary mb-3 fs-6">Add New Best Product Data</span>
              <h6>Best Product</h6>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Image Of Product</th>
                  ...
                  <tbody>
    @foreach ($bestproduct as $idx => $data)
        <tr>
            <td>
