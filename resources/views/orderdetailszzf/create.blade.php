...
@endsection
@section('page', 'Order Details ZZF / Create')
@section('main')
          ...
          <div class="card mb-4">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='{{route("orderdetailszzf.store")}}' method="post" id="frmUser">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        <label for="orders_id" class="form-label" required>Order Id</label>
                        <br>
                        <select name="orders_id" id="orders_id" class="form-control" required>
                            <option value="">
                                @foreach ($ordersidzzf as $o)
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="number" name="quantity" id="quantity" class="form-control" placeholder="input quantity order" aria-label="order_date">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                ...
                <div class="col-3">
                    <a href="{{ route('orderdetailszzf.index') }}" class="btn bg-gradient-secondary w-100">Cancel</a>
                </div>
                <div class="col-3">
