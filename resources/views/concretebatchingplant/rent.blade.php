...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Concrete Batching Plant Products <span class="text-primary">for Rent</span></h1>
            <p class="mb-0">The following are concrete batching plant Product for Rent</p>
        </div>
...
<div class="search-container-purchase">
                <form action="{{ url('product_search_rent/concrete_batching_plant') }}" method="GET" class="search-form">
