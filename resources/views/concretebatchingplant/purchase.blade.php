...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Concrete Batching Plant Products <span class="text-primary">for Sale</span></h1>
            <p class="mb-0">The following are concrete batching plant Product for Sale</p>
        </div>
...
<div class=""> 
    ...
    <p>Concrete batching plant adalah fasilitas yang digunakan untuk memproduksi beton secara massal dengan mencampur bahan-bahan seperti semen, pasir, kerikil, air, dan aditif dalam proporsi yang tepat. Plant ini terdiri dari berbagai komponen seperti silo untuk semen, hopper untuk agregat, mixer untuk pencampuran beton, dan sistem kontrol untuk memastikan kualitas dan kuantitas beton yang dihasilkan. Concrete batching plant dapat digunakan untuk proyek-proyek besar, seperti pembangunan gedung tinggi, jembatan, dan infrastruktur lainnya, karena dapat memproduksi beton dalam jumlah besar dengan konsistensi dan kualitas yang terjamin. Fasilitas ini membantu mempercepat proses konstruksi dan memastikan pengiriman beton yang tepat waktu ke lokasi proyek.</p>
</div>

<!-- Product Search -->
<div class="search-container-purchase">
                <form action="{{ url('product_search_purchase/concrete_batching_plant') }}" method="GET" class="search-form">
