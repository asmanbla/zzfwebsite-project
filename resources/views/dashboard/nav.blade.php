<!-- NAV -->
                          ...
                          <g transform="translate(-1716.000000, -439.000000)">
                              <g transform="translate(1716.000000, 291.000000)">
                                  <g transform="translate(0.000000, 148.000000)">
                                      <!-- Menambahkan background merah -->
                                      <rect x="0" y="0" width="45" height="40" fill="red" />
      ...
      <!-- Account Pages Navbar -->
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('userzzf.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('produkall.index') }}">
            ...
            <span class="nav-link-text ms-1">Product All</span>
          </a>
        </li>
        <!-- <li class="nav-item">
        <a class="nav-link  " href="{{ route('orderzzf.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>settings</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('orderdetailszzf.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
  <a class="nav-link" href="{{ route('sewazzf.index') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item">
  <a class="nav-link" href="{{ route('sewadetailszzf.index') }}">
    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
