...
@endsection
@section('page', 'Service Review ZZF / Edit')
@section('main')
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Create Review Service ZZF Edit</h6>
              <hr class="">
            </div>
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='{{route("servicereviewszzf.update")}}' method="post" id="frmRvw">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                        ...
                        <option value="{{ $servicereviewszzf->customers_id ?? old('customers_id') }}">
                        {{ $servicereviewszzf->customer->name ?? 'Pilih Pelanggan' }} 
                        </select>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                ...
                <div class="col-3">
                    <a href="{{ route('servicereviewszzf.index') }}" class="btn bg-gradient-secondary w-100">Cancel</a>
                </div>
                <div class="col-3">
