...
@endsection
@section('page', 'Service Review ZZF / Create')
@section('main')
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Create Review Service ZZF Form</h6>
              <hr class="">
            </div>
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='{{route("servicereviewszzf.store")}}' method="post" id="frmRvw">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                        <label for="customer_id" class="form-label">Customer Name (Id)</label>
