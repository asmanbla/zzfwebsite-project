...
<head>
    ...
    <meta charset="utf-8">
    <title>ZZF Industri - Detail Products</title>
    ...
    <div class="container">
        <div class="product-detail">
            <div class="product-images">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        @foreach ([$product->image1_url, $product->image2_url, $product->image3_url, $product->image4_url, $product->image5_url] as $image)
                            @if($image)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/' . $image) }}" alt="{{ $product->product_name }}" style="width: 520x; height: 445px;" class="product-image">
                                </div>
                            @endif
                        @endforeach
                    </div>
            ...
            <div class="product-info">
                ...
                <p class="card-text">
                    <span class="price" style="color: #A00000;">Price: Rp{{ number_format($product->price, 0) }}</span>
                </p>
