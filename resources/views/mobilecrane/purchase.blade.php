...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Mobile Crane Products <span class="text-primary">for Sale</span></h1>
            <p class="mb-0">The following are mobile crane Product for Sale</p>
        </div>
...
<div class=""> 
    ...
    <p>Mobile crane adalah jenis crane yang dirancang untuk dapat dipindahkan dan digunakan di berbagai lokasi konstruksi. Alat ini dilengkapi dengan roda atau track yang memungkinkan crane untuk bergerak secara fleksibel di medan yang berbeda. Mobile crane digunakan untuk mengangkat, memindahkan, dan menurunkan material berat di lokasi proyek. Terdapat berbagai tipe mobile crane, seperti **truck-mounted crane**, **crawler crane**, dan **all-terrain crane**, yang masing-masing memiliki kemampuan dan kegunaan spesifik. Dengan kemampuannya untuk bergerak cepat dan efisien, mobile crane sangat ideal untuk proyek-proyek yang memerlukan mobilitas tinggi dan pengangkatan material dalam berbagai kondisi medan.</p>
</div>

<!-- Product Search -->
<div class="search-container-purchase">
                <form action="{{ url('product_search_purchase/mobile_crane') }}" method="GET" class="search-form">
