...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Safety Net Products <span class="text-primary">for Sale</span></h1>
            <p class="mb-0">The following are safety net Product for Sale</p>
        </div>
...
<div class=""> 
    ...
    <p>Safety net adalah alat pelindung yang digunakan untuk mencegah pekerja jatuh atau melindungi objek dari ketinggian dalam proyek konstruksi. Terbuat dari bahan kuat seperti nylon, polyester, atau polypropylene, safety net dipasang di area kerja untuk menangkap pekerja atau material yang terjatuh. Jaring pengaman ini memiliki lubang dengan ukuran tertentu untuk memastikan kekuatan tarik yang optimal dan ketahanan terhadap cuaca ekstrem. Safety net sering dipasang di tepi bangunan atau struktur tinggi, memberikan perlindungan tambahan selama pekerjaan di ketinggian. Alat ini sangat penting untuk meningkatkan keselamatan kerja dan mengurangi risiko kecelakaan di lokasi konstruksi.</p>
</div>


<!-- Product Search -->
<div class="search-container-purchase">
                <form action="{{ url('product_search_purchase/safety_net') }}" method="GET" class="search-form">
