                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Id Sewa</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Jumlah Penyewaan</th>
                  ...
                  <tbody>
    @foreach ($paymentsewa as $idx => $data)
        <tr>
            <td>
            ...
            <td class="text-center">
                <div class="btn-group me-2">
                    <a href="{{ route('paymentsewaszzf.edit', $data->id) }}"  class="btn btn-secondary btn-sm">Ubah</a>
                    <a href="/hapuspaymentsewaszzf/{{$data->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini?')">Hapus</a>
                </div>
            </td>
        </tr>
    @endforeach
