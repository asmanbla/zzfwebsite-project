                  ...
                  <div class="mb-3 ms-3 me-3">
                    ...
                    <select name="product_category_id" id="product_category_id" class="form-control" required>
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="number" id="purchase_price" name="purchase_price" class="form-control" placeholder="Enter Your purchase_price" aria-label="purchase_price">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="price" class="form-label">Rent Price</label>
                        <input type="number" id="rent_price" name="rent_price" class="form-control" placeholder="Enter Your rent price (price /day)" aria-label="rent price">
                     </div>
                     <div class="mb-3 ms-3 me-3">
