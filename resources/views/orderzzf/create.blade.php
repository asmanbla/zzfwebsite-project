                ...
                <form action='{{route("orderzzf.store")}}' method="post" id="frmUser">
                  ...
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="password" name="total_amount" class="form-control" placeholder="masukkan total amoount anda" aria-label="total_amount">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                      ...
                      <select class="form-select" aria-label="Default select example" id="roles" name="roles" >
                        ...
                        <option value="admin">Menunggu Pembayaran</option>
                        <option value="admin">Di Proses</option>
