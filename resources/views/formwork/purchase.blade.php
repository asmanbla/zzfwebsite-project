...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Form Work Products <span class="text-primary">for Sale</span></h1>
            <p class="mb-0">The following are form work Product for Sale</p>
        </div>
...
<div class=""> 
    ...
    <p>Formwork adalah sistem cetakan sementara yang digunakan dalam konstruksi untuk membentuk beton pada struktur bangunan. Formwork berfungsi sebagai penahan beton cair hingga mengeras dan mencapai kekuatan yang diperlukan. Biasanya, formwork terbuat dari bahan seperti kayu, baja, atau plastik, tergantung pada kebutuhan dan jenis proyek. Sistem ini sangat penting dalam pembangunan fondasi, kolom, dinding, dan lantai pada bangunan bertingkat. Formwork dirancang untuk menahan beban beton yang berat dan memastikan bentuk yang akurat. Setelah beton mengeras, formwork dapat dibongkar dan digunakan kembali pada bagian lain dari proyek konstruksi. Formwork yang efisien dapat mengurangi waktu dan biaya konstruksi.</p>
</div>
...
<div class="search-container-purchase">
                <form action="{{ url('product_search_purchase/form_work') }}" method="GET" class="search-form">
