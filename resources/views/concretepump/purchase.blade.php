...
<div class="container-fluid categories pb-5" id="produk">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
            <h1 class="display-5 text-capitalize mb-3">Concrete Pump Products <span class="text-primary">for Sale</span></h1>
            <p class="mb-0">The following are concrete pump Product for Sale</p>
        </div>
...
<div class=""> 
    ...
    <p>Concrete pump adalah alat yang digunakan untuk memompa dan menyalurkan beton cair dari mixer ke lokasi yang sulit dijangkau dalam proyek konstruksi. Alat ini dilengkapi dengan pipa fleksibel atau rigid yang mengarah ke area target, memungkinkan beton dipompa dengan efisien ke lantai tinggi atau area sempit. Concrete pump tersedia dalam dua jenis utama: **boom pump**, yang dilengkapi dengan boom hidrolik untuk mencapai ketinggian dan jangkauan luas, dan **line pump**, yang menggunakan pipa fleksibel untuk memompa beton dalam jarak lebih pendek. Penggunaan concrete pump mempercepat proses pengecoran, meningkatkan efisiensi, dan mengurangi kebutuhan tenaga kerja manual di lokasi konstruksi.</p>
</div>


<!-- Product Search -->
<div class="search-container-purchase">
                <form action="{{ url('product_search_purchase/concrete_pump') }}" method="GET" class="search-form">
