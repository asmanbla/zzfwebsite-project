...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        $payments = Payments::where('sellers_id', $sellers_id)->get();
    ...
    public function edit(string $id)
    {
        ...
        $payment = PaymentsSellers::where('id', $id)
    ...
    public function destroy(string $id)
        {
            ...
            return redirect()->route('payment.index')->with('success', 'Payment Order Deleted Successfully!!');
        }
